...
2. ["Knowledge-Guided Brain Tumor Segmentation via Synchronized Visual-Semantic-Topological Prior Fusion"](../paper/4.pdf) (**Array, JCR Q1**) <span style="color:blue">[Under Review]</span> — Integrating VLM models and deep learning for brain tumor recognition. (**Mingda Zhang** — **solo** author) [PDF](../paper/Array.pdf)
