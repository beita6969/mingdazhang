...
4. [“Knowledge-Guided Brain Tumor Segmentation via Synchronized Visual-Semantic-Topological Prior Fusion”](../paper/4.pdf) — Integrating VLM models and deep learning for brain tumor recognition. (**Mingda Zhang** — **solo** author) [PDF](../paper/Array.pdf)
...
7. [“Multimodal Fusion at Three Tiers: Physics-Driven Data Generation and Vision-Language Guidance for Brain Tumor Segmentation”](../paper/7.pdf) — Bidirectional interaction between VLM models and deep learning for brain tumor recognition. (**Mingda Zhang**, Kaiwen Pan) [PDF](../paper/7.pdf)
